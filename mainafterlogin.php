...
<head>
	...
	<style>
		...
		.lgdropdown-content a:hover {background-color: #f1f3f6;}

		.lgdropdown:hover .lgdropdown-content {display: block;}

		.lgdropdown:hover .lgdropbtn {background-color: #047BD5;}
	</style>
<body bgcolor="#f1f3f6">
	<div class="header">
		<table border="0" width="100%" bgcolor="047BD5" class="table1">
			<tr>
				...
				<th width="20%">
					<div class="lgdropdown">
	  					<button class="lgdropbtn"><i class="fa fa-sign-in" aria-hidden="true" style="color:white;"></i><font color="white">    Hello <?php echo $_SESSION['username']; ?></font><br></button>
						  <div class="lgdropdown-content">
						    <a href="#">My Account</a>
						    <a href="#">Orders</a>
						    <a href="#">Wishlist</a>
						    <a href="#">Cart</a>
						    <a href="mainafterlogin.php?logout=1" class="logout" name="logout">Logout</a>
						  </div>
					</div>
				</th>
			</tr>
